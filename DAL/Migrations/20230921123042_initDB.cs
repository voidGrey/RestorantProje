        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreateTime = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2023, 9, 21, 15, 30, 41, 896, DateTimeKind.Local).AddTicks(2020)),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FirmaId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    CreateTime = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2023, 9, 21, 15, 30, 41, 896, DateTimeKind.Local).AddTicks(8416)),
                    UpdateTime = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FirmaId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    CreateTime = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2023, 9, 21, 15, 30, 41, 899, DateTimeKind.Local).AddTicks(7914)),
                    UpdateTime = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FirmaId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    CreateTime = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2023, 9, 21, 15, 30, 41, 897, DateTimeKind.Local).AddTicks(4441)),
                    UpdateTime = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FirmaId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    CreateTime = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2023, 9, 21, 15, 30, 41, 900, DateTimeKind.Local).AddTicks(3670)),
                    UpdateTime = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FirmaId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    CreateTime = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2023, 9, 21, 15, 30, 41, 899, DateTimeKind.Local).AddTicks(3300)),
                    UpdateTime = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Fiyat = table.Column<double>(type: "float", nullable: false),
                    FirmaId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    CreateTime = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2023, 9, 21, 15, 30, 41, 898, DateTimeKind.Local).AddTicks(6730)),
                    UpdateTime = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2023, 9, 21, 15, 30, 41, 896, DateTimeKind.Local).AddTicks(4175), null, "Yiyecekler", "Ana Yemek", null },
                    { 2, new DateTime(2023, 9, 21, 15, 30, 41, 896, DateTimeKind.Local).AddTicks(4183), null, "Çorba v.b.", "Ara Sıcaklar", null },
                    { 3, new DateTime(2023, 9, 21, 15, 30, 41, 896, DateTimeKind.Local).AddTicks(4186), null, "Tatlılar", "Tatlı", null },
                    { 4, new DateTime(2023, 9, 21, 15, 30, 41, 896, DateTimeKind.Local).AddTicks(4189), null, "Şarap v.b.", "Alkollü İçecekelr", null },
                    { 5, new DateTime(2023, 9, 21, 15, 30, 41, 896, DateTimeKind.Local).AddTicks(4191), null, "Kola, su v.b.", "Alkolsüz İçecekler", null }
                });

            migrationBuilder.InsertData(
                table: "Kullanicilar",
                columns: new[] { "ID", "CreateTime", "FirmaId", "KullaniciAdi", "Sifre", "UpdateTime" },
                values: new object[] { 1, new DateTime(2023, 9, 21, 15, 30, 41, 897, DateTimeKind.Local).AddTicks(673), null, "Admin", "123", null });

            migrationBuilder.InsertData(
                table: "Masalar",
                columns: new[] { "ID", "FirmaId", "MasaID", "MasaSifresi", "UpdateTime" },
                values: new object[,]
                {
                    { 1, null, 1, null, null },
                    { 2, null, 2, null, null },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2023, 9, 21, 15, 30, 41, 897, DateTimeKind.Local).AddTicks(6401), null, "Admin", null });
