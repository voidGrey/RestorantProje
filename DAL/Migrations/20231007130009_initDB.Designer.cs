...
namespace DAL.Migrations
{
    ...
    [Migration("20231007130009_initDB")]
            ...
            modelBuilder.Entity("Entites.Concrate.Kategori", b =>
                {
                    ...
                    b.Property<DateTime>("CreateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 10, 7, 16, 0, 9, 550, DateTimeKind.Local).AddTicks(8243));
            ...
            modelBuilder.Entity("Entites.Concrate.Kullanici", b =>
                {
                    ...
                    b.Property<DateTime>("CreateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 10, 7, 16, 0, 9, 551, DateTimeKind.Local).AddTicks(1374));
            ...
            modelBuilder.Entity("Entites.Concrate.Masa", b =>
                {
                    ...
                    b.Property<DateTime>("CreateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 10, 7, 16, 0, 9, 552, DateTimeKind.Local).AddTicks(8478));
            ...
            modelBuilder.Entity("Entites.Concrate.Role", b =>
                {
                    ...
                    b.Property<DateTime>("CreateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 10, 7, 16, 0, 9, 551, DateTimeKind.Local).AddTicks(5417));
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1,
                            CreateTime = new DateTime(2023, 10, 7, 16, 0, 9, 551, DateTimeKind.Local).AddTicks(6769),
                            RoleAdi = "Admin"
                        });
                });
            ...
            modelBuilder.Entity("Entites.Concrate.SiparisDetay", b =>
                {
                    ...
                    b.Property<DateTime>("CreateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 10, 7, 16, 0, 9, 552, DateTimeKind.Local).AddTicks(2829));
            ...
            modelBuilder.Entity("Entites.Concrate.SiparisMaster", b =>
                {
                    ...
                    b.Property<DateTime>("CreateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 10, 7, 16, 0, 9, 552, DateTimeKind.Local).AddTicks(5626));
            ...
            modelBuilder.Entity("Entites.Concrate.Urun", b =>
                {
                    ...
                    b.Property<DateTime>("CreateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 10, 7, 16, 0, 9, 553, DateTimeKind.Local).AddTicks(1465));
